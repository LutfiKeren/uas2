...
<head>
    ...
    <title>Pendaftaran siswa baru ypui</title>
    <link rel="icon" type="image/png" href="../../assets/img/bg_title.jpg">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 shadow" style="width:100%">
        <div class="container">
            <a class="navbar-brand" href="http://ypuijakarta.blogspot.com/">
                <img src="../../assets/img/bg_title.jpg" width="30" height="30" alt="logosmk">
                <span class="align-middle">SMK YPUI</span>
            </a>
        ...
        <div class="container text-light">
            <div class="row p-4">
                <div class="col text-center">
                    <h4>CONTACT</h4>
                    <div>
                        <p class="m-2"><i class="fa fa-envelope mr-2"></i>smkypui@yahoo.com</p>
                        <p class="m-2"><i class="fa fa-phone mr-2"></i>0274-367156 / 0274-6462740</p>
                        <p class="m-2"><i class="fa fa-fax mr-2"></i>0232123456</p>
                    </div>
                    <div>
                        <a href="https://www.instagram.com/smkypui_jkt/" class="text-light mx-1"><i
                ...
                <div class="col text-center">
                    <h4>ADDRESS</h4>
                    <p>Jl. Praja Lapangan No. 8<br>Kebayoran Lama<br> Kebayoran Lama Selatan<br> Kota Jakarta Selatan </p>
                </div>
                <div class="col text-center">
                    <h4>NAVIGATE</h4>
