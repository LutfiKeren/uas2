<!-- Main jumbotron for a primary marketing message or call to action -->
        ...
        <div class="container p-3">
            <div class="row">
                <div class="col-8">
                    <h4>Galeri SMEA</h4>
                    <img src="../../assets/img/ceramah.jpg" alt="" width="200">
                    <img src="../../assets/img/upacara.jpg" alt="" width="200">
                    <img src="../../assets/img/ypui.jpg" alt="" width="200">
                </div>
                <div class="col-4">
                    <div class="card shadow m-2">
                        <div class="card-body">
                            <h6>Pemilos SMK YPUI periode 2019/2020</h6>
                        </div>
                    </div>
                    <div class="card shadow m-2">
                        <div class="card-body">
                    ...
                    <div class="card shadow m-2">
                        <div class="card-body">
                            <h6>Pelaksanaan uji kompetensi keahllian tahun ajaran 2019/2020</h6>
                        </div>
                    </div>
                </div>
            </div>
